...
const (
	...
	CodeSessionSourceCannotOwnSession    ValidationErrorCode = "workflow.validation.session_source_cannot_own_session"
	CodeSessionTransitionMissing         ValidationErrorCode = "workflow.validation.session_transition_missing"
	CodeSessionTransitionNotGuaranteed   ValidationErrorCode = "workflow.validation.session_transition_not_guaranteed"
	CodeSessionTransitionAmbiguous       ValidationErrorCode = "workflow.validation.session_transition_ambiguous"
