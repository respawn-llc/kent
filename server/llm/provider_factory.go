	...
	return []ProviderContract{
		...
		},
		{
			...
			ModelContracts: []ModelCapabilityContract{
				...
				{Model: "gpt-5.4-mini", ContextWindowTokens: 128_000, LargeContextWindowTokens: 400_000, SupportsReasoningEffort: true, SupportedReasoningEfforts: []string{"low", "medium", "high", "xhigh"}, SupportsReasoningSummary: true, SupportsVerbosity: true, SupportedVerbosityLevels: []string{"low", "medium", "high"}, SupportsVisionInputs: true},
