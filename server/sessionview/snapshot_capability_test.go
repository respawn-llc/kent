...
func TestSessionSnapshotCapabilitiesCoverReadModelFields(t *testing.T) {
	covered := map[reflect.Type]map[string]struct{}{
		...
		reflect.TypeOf(clientui.TranscriptPage{}):                   fieldSet("SessionID", "SessionName", "ConversationFreshness", "Revision", "TotalEntries", "Offset", "NextOffset", "HasMore", "OlderCursor", "HasMoreAbove", "Entries", "Streaming", "StreamingError"),
