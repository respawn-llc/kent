...
func registerSessionViewGatewayBinaryBindings(bindings map[string]gatewayBinaryBinding) error {
	...
	return errors.Join(
		...
		registerSessionViewUnary(bindings, sessionService, "GetExecutionEnvironment",
			func() *sessionpb.ExecutionEnvironmentRequest { return &sessionpb.ExecutionEnvironmentRequest{} },
			apicontract.SessionViewService.GetSessionExecutionEnvironment),
