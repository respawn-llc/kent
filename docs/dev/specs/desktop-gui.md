...
- Process termination loading must end when its request settles. Desktop must refresh the process list separately and surface refresh failures. Other Processes must remain independently actionable.
