...
test("builder/no-array-index-key rejects index-like keys only", () => {
  ...
  tester.run("builder/no-array-index-key", builderArchitecture.rules["no-array-index-key"], {
    valid: [
      {
...
test("builder/no-raw-dto-in-components handles lowercase component files", () => {
  ...
  tester.run("builder/no-raw-dto-in-components", builderArchitecture.rules["no-raw-dto-in-components"], {
    valid: [
      {
...
test("builder/no-useeffect-data-loading catches React.useEffect and aliased useEffect in components", () => {
  ...
  tester.run("builder/no-useeffect-data-loading", builderArchitecture.rules["no-useeffect-data-loading"], {
    valid: [
      {
        code: `
...
test("builder/no-mutable-exports rejects exported let and var", () => {
  ...
  tester.run("builder/no-mutable-exports", builderArchitecture.rules["no-mutable-exports"], {
