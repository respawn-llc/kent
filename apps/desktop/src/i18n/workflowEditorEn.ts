export const workflowEditorEnglish = {
  ...
  executionTargetPolicy: "Execution target",
  executionTargetPolicyHelp: "Choose where this workflow creates and runs task work.",
  executionTargetPolicy_none: "No managed worktree",
  executionTargetPolicy_noneHelp: "Run directly from the task's source workspace.",
  executionTargetPolicy_head: "Source HEAD",
  executionTargetPolicy_headHelp: "Create a managed worktree from the source workspace's current HEAD.",
  executionTargetPolicy_default_branch: "Repository default branch",
  ...
  executionTargetCustomRef: "Git revision",
  ...
  contextSourceHelp:
    "When continuing a Session, where the retained conversation comes from.\n\nImmediate source: the transition's source node Session.\n\nPrevious target Session: the latest retained Session previously associated with this target in guaranteed loops.\n\nPrevious target Session or new Session: that retained Session when one exists, otherwise a new Session.",
  ...
  contextSourcePreviousTarget: "Previous retained Session of this target",
  contextSourcePreviousTargetOrNew: "Previous retained Session of this target, or new Session",
