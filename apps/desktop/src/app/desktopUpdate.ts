...
// Checks for an available update, guarding on the updater capability and
// swallowing transient check failures. A failed check stays silent (no error
// chip): the next launch retries. Returns available:false when the shell can't
// update or the check failed.
