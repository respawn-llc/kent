...
function Harness({ openNative }: Readonly<{ openNative: () => Promise<void> }>) {
  return (
    <StatusProvider>
      <HarnessContent openNative={openNative} />
    </StatusProvider>
  );
}

function HarnessContent({ openNative }: Readonly<{ openNative: () => Promise<void> }>) {
