...
function Composer({
  ...
  const settings = useChatSettings(
    newChat
      ? {
          target: { kind: "new_chat", projectID: target.projectID, workspace: target.workspace },
          onInitialSettingsChange: () => undefined,
        }
      : {
          target: { ...target, kind: "session" },
          authoritativeRefreshGeneration: 0,
          onContextChange: () => undefined,
          openTask: () => undefined,
          openParentSession: () => undefined,
        },
  );
